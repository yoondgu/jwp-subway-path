...
insert ignore into LINE (id, name, color, additional_charge) VALUES(4, '신분당선', 'red', 500);
...
insert ignore into STATION (id, name) VALUES(11, '강남역');
insert ignore into STATION (id, name) VALUES(12, '양재역');
insert ignore into STATION (id, name) VALUES(13, '신사역');
